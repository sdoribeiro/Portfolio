...
class Trade(models.Model):
    ...
    def __str__(self):
        return f"{self.id} - {self.ticker} : {self.date} / {self.quantity} / {self.price} / {self.tax}"

class PorfolioComp(models.Model):
    portfolio = models.ForeignKey(Portfolio, on_delete=models.Case, related_name="portfolio")
